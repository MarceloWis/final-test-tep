...
export default class Home extends Component {
  ...
  loadRepositories = async () => {
    ...
    const repositories = JSON.parse(await AsyncStorage.getItem('@FinalTestTEP:repositories'));
  ...
  renderList = () => {
    ...
    return !repositories.length ? (
      <>
        ...
        <Text style={styles.empty}>This App was developed by: Marcelo, Leonardo e Aline</Text>
      </>
    ) : (
      <FlatList
        data={repositories}
